...
class Alert: UIView {
    ...
    func showWithCancelButton(with style: UIAlertController.Style ,in controller: UIViewController? = nil ,title: String?, message : String, confirmTitle: String = "Done", buttonAction: @escaping () -> Void) {
    ...
    func showConfirmButtonsAndCancel(with style: UIAlertController.Style, in controller: UIViewController? = nil ,title: String? , message : String?, confirmTitle: String, confirmedHandler: @escaping () -> (), cancelTitle: String, cancelHandler: @escaping () -> ()) {
        let alertController = UIAlertController(title: title, message:
            message, preferredStyle: style)
    ...
    func showTwoButtonsAndCancel(with style: UIAlertController.Style, in controller: UIViewController? = nil ,title: String? , message : String?, firstConfirmTitle: String, secondConfirmTitle: String, firstConfirmedAction: @escaping () -> (), secondConfirmedAction: @escaping () -> (), cancelTitle: String, cancelAction: (() -> ())? = nil) {
    ...
    func showThreeButtonsAndCancel(with style: UIAlertController.Style, in controller: UIViewController? = nil ,title: String? , message : String?, firstConfirmTitle: String, secondConfirmTitle: String, thirdConfirmTitle: String, firstConfirmedAction: @escaping () -> (), secondConfirmedAction: @escaping () -> (), thirdConfirmedAction: @escaping () -> (), cancelTitle: String = "Cancel", cancelAction: (() -> ())? = nil) {
