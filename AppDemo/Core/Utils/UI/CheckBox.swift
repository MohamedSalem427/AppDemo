...
public class CheckBox: UIControl {
    ...
    ///
    /// **Default:** `2`
    public var CBBorderWidth: CGFloat = 2
    ...
    private func drawBorder(shape: BorderStyle, in rect: CGRect) {
        let adjustedRect = CGRect(x: CBBorderWidth/2,
                                  y: CBBorderWidth/2,
                                  width: rect.width-CBBorderWidth,
                                  height: rect.height-CBBorderWidth)
    ...
    private func squareBorder(rect: CGRect) {
        ...
        rectanglePath.lineWidth = CBBorderWidth
    ...
    private func circleBorder(rect: CGRect) {
        ...
        ovalPath.lineWidth = CBBorderWidth / 2
        ovalPath.stroke()
        checkboxBackgroundColor.setFill()
        ovalPath.fill()
    }
    ...
    func setDefault() {
        ...
        self.checkmarkColor = .midnightBlue
        self.checkmarkStyle = .circle
        self.borderStyle = .circle
        self.checkedBorderColor = .midnightBlue
        self.uncheckedBorderColor = .midnightBlue
    }
