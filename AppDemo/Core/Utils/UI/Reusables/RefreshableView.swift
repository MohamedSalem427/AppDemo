...
struct RefreshableScrollView<Content: View>: View {
            ...
            VStack {
                ScrollView {
                    ZStack(alignment: .top) {
                        MovingView()
                        VStack { content.frame(height: gr.size.height) }
                ...
                .onPreferenceChange(RefreshableKeyTypes.PrefKey.self,perform: refreshLogic)
            }
        }
    }
    ...
    struct SymbolView: View {
        @SwiftUI.Environment(\.assets) var assets: Assets
        ...
        var body: some View {
            Group {
                if loading { // If loading, show the activity control
                    ...
                    Image(systemName: assets.arrowDown) // If not loading, show the arrow
                        .resizable()
